...
/// </summary>
[Node(false, "Dialog/Choice Node", new Type[]{typeof(DialogNodeCanvas)})]
public class DialogMultiOptionsNode : BaseDialogNode
{
	public override string Title { get { return "Choice Node"; } }
	...
	public override BaseDialogNode Input(int inputValue)
	{
		switch (inputValue)
		{
		case (int)DialogInputValue.Next:
			break;

		case (int)DialogInputValue.Back:
